    ...
    <div className="p-8 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6">
        ...
        {canManage ? (
          <section className="bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-gray-800">教材知识树管理</h2>
            ...
            {loadingTree ? (
              ...
              <div className="max-h-[500px] overflow-y-auto border border-gray-100 rounded-xl p-2">
                {tree.map((node) => (
          ...
          <section className="bg-white rounded-2xl border border-dashed border-gray-200 p-12 text-center text-gray-400">
            仅管理员和教师可以管理教材知识树</section>
        )}
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white rounded-2xl border border-gray-100 p-6">
            <h3 className="text-base font-bold text-gray-800 mb-3">个人信息</h3>
            <div className="space-y-2 text-sm">
              {[["用户名", user.username], ["显示名", user.display_name ?? "未设置"],
                ["邮箱", user.email], ["角色", user.role === "admin" ? "管理员" : user.role === "teacher" ? "教师" : "学生"],
              ].map(([label, value]) => (
