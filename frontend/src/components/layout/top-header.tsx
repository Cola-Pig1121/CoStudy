...
export function TopHeader() {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-100 flex items-center px-4 sm:px-8 gap-4 shrink-0">
      {/* 移动端汉堡菜单 */}
      {isMobile && (
      ...
      <div className="flex-1 max-w-xl mx-auto">
        <div className="relative">
          ...
          <input type="text" placeholder="搜索教材、资源、笔记..."
          ...
          <kbd className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-gray-400 bg-gray-100 px-1.5 py-0.5 rounded font-mono hidden sm:block">⌘K</kbd>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button className="relative p-2.5 rounded-xl text-gray-500 hover:bg-gray-50 hover:text-gray-700 transition-colors hidden sm:block">
