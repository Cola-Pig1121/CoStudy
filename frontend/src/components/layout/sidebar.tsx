  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-[240px] bg-white border-r border-gray-100 flex flex-col z-40">
      ...
      <div className="h-16 flex items-center gap-3 px-5 border-b border-gray-100 shrink-0">
        <div className="h-8 w-8 rounded-lg bg-[#4a9d9a] flex items-center justify-center">
          ...
          {NAV_ITEMS.map((item) => {
            ...
            if (item.disabled) {
              return (
                <div
                  key={item.href}
                  className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-gray-300 cursor-not-allowed"
                >
      ...
      <div className="border-t border-gray-100 p-3 shrink-0">
        ...
        {/* 用户信息 */}
        <div className="flex items-center gap-3 px-3 py-2.5 mt-1 rounded-xl bg-gray-50">
